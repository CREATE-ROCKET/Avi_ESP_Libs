...
inline esp_err_t avi_spi_add(SPICREATE& spi, int cs, uint32_t frequency, uint8_t mode,
                             SPICREATE::Device& device) {
...
inline esp_err_t avi_spi_read(SPICREATE& spi, SPICREATE::Device device, uint8_t command,
