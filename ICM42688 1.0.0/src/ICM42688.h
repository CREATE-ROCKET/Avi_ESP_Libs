...
void ICM::begin(SPICREATE::SPICreate *targetSPI, int cs, uint32_t freq)
{
    ...
    delay(1);
    ICMSPI->setReg(0x79, 0b00000001, deviceHandle);
    delay(1);
    ICMSPI->setReg(0x7A, 0b00000000, deviceHandle);
    // delay(1);
    ...
    delay(1);
    ICMSPI->setReg(0x54, 0b00010101, deviceHandle);//timestanp
    delay(1);
