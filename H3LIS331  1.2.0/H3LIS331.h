...
#define H3LIS331_CTRL_REG1_Address \
    0x20  // CTRL_REG1 Power Mode & Output Data Rate
#define H3LIS331_CTRL_REG2_Address \
    0x21  // CTRL_REG2 (Normally they do not have to be changed)
...
#define H3LIS331_CTRL_REG1 \
    0b00111111  // CTRL_REG1 Normal Mode & OutPut Data Rate 1000Hz ????????????
// #define H3LIS331_CTRL_REG1 0b0001111       // CTRL_REG1 default value
#define H3LIS331_CTRL_REG2 \
    0b00000000  // CTRL_REG2 (Normally they do not have to be changed)
...
void H3LIS331::begin(SPICREATE::SPICreate *targetSPI, int cs, uint32_t freq) {
    ...
    // 1kHzにする
    H3LIS331SPI->setReg(H3LIS331_CTRL_REG1_Address, H3LIS331_CTRL_REG1,
                        deviceHandle);
    H3LIS331SPI->setReg(H3LIS331_CTRL_REG2_Address, H3LIS331_CTRL_REG2,
                        deviceHandle);
    H3LIS331SPI->setReg(H3LIS331_CTRL_REG3_Address, H3LIS331_CTRL_REG3,
                        deviceHandle);
    // Init
    H3LIS331SPI->setReg(H3LIS331_CTRL_REG4_Address, H3LIS331_CTRL_REG4_400G,
                        deviceHandle);
    // SleepAndWakeをOFFにする
    H3LIS331SPI->setReg(H3LIS331_CTRL_REG5_Address, H3LIS331_CTRL_REG5,
                        deviceHandle);
    H3LIS331SPI->setReg(H3LIS331_STATUS_REG_Address, H3LIS331_STATUS_REG,
                        deviceHandle);
    return;
}
uint8_t H3LIS331::WhoImI() { return H3LIS331::WhoAmI(); }
